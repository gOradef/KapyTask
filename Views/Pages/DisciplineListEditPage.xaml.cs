...
public partial class DisciplineListEditPage : ContentPage, INotifyPropertyChanged
{
    ...
    private void ButtonEditDiscipline_OnClicked(object? sender, EventArgs e)
    {
        var button = sender as Button;
        var discipline = button?.BindingContext as KDiscipline;
        if (discipline is not null)
        {
            Navigation.PushModalAsync(new DisciplineEditModal(discipline));
        }
    }
}